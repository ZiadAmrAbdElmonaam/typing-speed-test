...
export function ContactScreen({ onBack }: ContactScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 dark:bg-black dark:from-transparent dark:via-transparent dark:to-transparent">
